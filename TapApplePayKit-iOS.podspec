#
#  Be sure to run `pod spec lint TapApplePayKit-iOS.podspec' to ensure this is a
...
Go all the way until Apple Pay tokenisation data."
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapApplePayKit-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TapApplePayKit-iOS/Core/**/*.{h,m,swift}"
